import{j as e,L as i}from"./index-By_zGcNR.js";import{P as t,A as s,C as o}from"./AlertBox-CZTB6a28.js";function n(){return e.jsxs(t,{title:"Git Hooks",subtitle:"Scripts que rodam automaticamente em eventos do Git — bloquear commits ruins, rodar testes, formatar código antes do push.",difficulty:"intermediario",timeToRead:"13 min",children:[e.jsx(s,{type:"info",title:"Pré-requisitos",children:"Familiaridade com terminal e noções básicas de versionamento. Se ainda não viu o capítulo de instalação ou primeiros passos, comece por lá."}),e.jsx("h2",{children:"Glossário rápido"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx("strong",{children:"Hook"})," "," — "," ","script disparado por evento Git (pre-commit, pre-push, etc)."]}),e.jsxs("li",{children:[e.jsx("strong",{children:".git/hooks/"})," "," — "," ","pasta local; não é versionada por padrão."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"Husky"})," "," — "," ","gerencia hooks no JS/TS, versionados via package.json."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"lint-staged"})," "," — "," ","roda linter só nos arquivos staged."]}),e.jsxs("li",{children:[e.jsx("strong",{children:"pre-receive"})," "," — "," ","no servidor: rejeita pushes inválidos."]})]}),e.jsxs("p",{children:[e.jsx("strong",{children:"Hooks"})," são scripts que o Git executa em momentos específicos: antes de um commit, depois de um merge, antes de um push. Eles são a base de toda automação local — desde lint até validação de mensagens, geração de docs e bloqueio de segredos."]}),e.jsxs(s,{type:"tip",title:"Onde moram",children:["Por padrão em ",e.jsx("code",{children:".git/hooks/"})," — que ",e.jsx("strong",{children:"não é versionado"}),". Para compartilhar hooks com o time, use ",e.jsx("code",{children:"core.hooksPath"})," apontando para uma pasta versionada."]}),e.jsx("h2",{children:"Estrutura de um hook"}),e.jsx(o,{title:"Anatomia",language:"bash",code:`# Hooks são scripts executáveis em qualquer linguagem
ls .git/hooks/
...
`}),e.jsx("h2",{children:"Os hooks mais úteis"}),e.jsx(o,{title:"Mapa rápido",language:"markdown",code:`CLIENT-SIDE (no seu computador)
...
`}),e.jsx("h2",{children:"pre-commit — o mais útil"}),e.jsx(o,{title:"Bloqueia console.log e prettier check",language:"bash",code:`#!/bin/sh
...
exit 0
`}),e.jsx(o,{title:"Bloquear arquivos grandes (> 5MB)",language:"bash",code:`#!/bin/sh
# .git/hooks/pre-commit
...
`}),e.jsx(o,{title:"Detectar segredos vazados",language:"bash",code:`#!/bin/sh
# .git/hooks/pre-commit
...
`}),e.jsx("h2",{children:"commit-msg — validar mensagens"}),e.jsx(o,{title:"Conventional Commits validator",language:"bash",code:`#!/bin/sh
...
`}),e.jsx("h2",{children:"pre-push — testes antes do push"}),e.jsx(o,{title:"Roda CI local",language:"bash",code:`#!/bin/sh
# .git/hooks/pre-push
...
`}),e.jsx("h2",{children:"Compartilhando hooks com o time"}),e.jsx(o,{title:"core.hooksPath versionado",language:"bash",code:`# 1. Crie pasta versionada
mkdir .githooks
...
`}),e.jsx("h2",{children:"Husky — gerenciador de hooks moderno"}),e.jsx(o,{title:"Para projetos Node.js",language:"bash",code:`# Instalar
...
`}),e.jsx("h2",{children:"pre-commit framework — universal"}),e.jsx(o,{title:"Para qualquer linguagem",language:"bash",code:`# pip install pre-commit  ou  brew install pre-commit
...
`}),e.jsx("h2",{children:"post-merge — automação útil"}),e.jsx(o,{title:"Auto-install após pull",language:"bash",code:`#!/bin/sh
# .githooks/post-merge
...
`}),e.jsx("h2",{children:"Pulando hooks (quando necessário)"}),e.jsx(o,{title:"--no-verify",language:"bash",code:`# Pular pre-commit + commit-msg
...
`}),e.jsx(s,{type:"warning",title:"Use --no-verify com responsabilidade",children:'Hooks existem por razões. Pular ocasionalmente é ok (commit "wip" no fim do dia). Pular sempre vira "para que serve isso então?".'}),e.jsx("h2",{children:"Hooks server-side (auto-hospedado)"}),e.jsx(o,{title:"pre-receive — bloquear no servidor",language:"bash",code:`#!/bin/sh
...
`}),e.jsx("h2",{children:"Cheat-sheet"}),e.jsx(o,{title:"Hooks essenciais",language:"bash",code:`# Ativar (remover .sample, chmod +x)
...
`}),e.jsx("h2",{children:"Próximos passos"}),e.jsxs("ul",{children:[e.jsxs("li",{children:[e.jsx(i,{href:"/configuracao",children:"Configurações"})," — outras automações"]}),e.jsxs("li",{children:[e.jsx(i,{href:"/conventional-commits",children:"Conventional Commits"})," — padrão para validar"]}),e.jsxs("li",{children:[e.jsx(i,{href:"/signing",children:"Signing"})," — hooks que exigem assinatura"]})]})]})}export{n as default};
